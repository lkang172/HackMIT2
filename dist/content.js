...
const PROMPT_TEXTAREA_SELECTOR = 'textarea[data-id="root"], textarea[placeholder*="Message"]';
...
async function extractPdfText(file) {
  ...
  reader.onload = async (event) => {
    try {
      const pdf = await __webpack_exports__getDocument({ data: event.target.result }).promise;
      let fullText = "";
